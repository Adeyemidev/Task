...
<div className='m-auto text-center max-w-80 h-screen'>

<div className=' pt-10 pb-10 bg-blue-700 relative z-30 rounded-t-lg'>
...
<div className='bg-white py-10 relative z.-30 rounded-b-lg'>
